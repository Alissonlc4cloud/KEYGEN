...
cd /var/www/html
wget https://www.dropbox.com/s/vodtpyy22u3yf5d/v20.zip > /dev/null 2>&1
...
sleep 1
cd
wget https://raw.githubusercontent.com/rodrigo12xd/KEYGEN/master/SSHPlus_SourceCodes/Paniel_v20/banco.sql > /dev/null 2>&1
sleep 1
...
cd /bin
wget https://raw.githubusercontent.com/rodrigo12xd/KEYGEN/master/SSHPlus_SourceCodes/Paniel_v20/html.sh > /dev/null 2>&1 && chmod 777 html.sh && sed -i -e 's/\r$//' html.sh && ./html.sh
